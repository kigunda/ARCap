...
# setting SOPC_SYSID_BASE_ADDRESS is 0x200a0c8
SOPC_SYSID_FLAG += --sidp=0x200a0c8
ELF_PATCH_FLAG  += --sidp 0x200a0c8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1395959215
SOPC_SYSID_FLAG += --timestamp=1395959215
ELF_PATCH_FLAG  += --timestamp 1395959215
