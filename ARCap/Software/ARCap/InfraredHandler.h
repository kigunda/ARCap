...
/*
 * The infrared handler reads from the infrared receivers and sends signals through the infrared emitters.
 * It is a data source for infrared receive events and posts level readings from the receivers to its listeners.
 */
...
private:
	 ...
	 */
	Status post(unsigned int level);
